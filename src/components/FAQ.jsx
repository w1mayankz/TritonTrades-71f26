        ...
        {faqs.map((faq, i) => {
          ...
          return (
            ...
            >
              ...
              >
                {/* Updated size here: text-base md:text-lg */}
                <span className="text-white font-['Barlow'] text-base md:text-lg font-medium pr-8">
                  {faq.question}
                </span>
                ...
                {isOpen && (
                  ...
                  >
                    <div className="px-6 pb-6">
                      ...
                      <p className="text-white/70 font-['Barlow'] text-sm leading-relaxed">
                        {faq.answer}
                      </p>
                    </div>
                  </motion.div>
