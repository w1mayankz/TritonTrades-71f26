      ...
      >
        ...
        <div className="flex flex-col items-center justify-center w-full max-w-4xl">
          ...
          <BlurText
            ...
            animateBy="words"
            direction="bottom"
            className="text-4xl md:text-7xl lg:text-[5.5rem] font-['Inter_Tight'] font-bold not-italic text-white leading-[0.8] tracking-[-4px] justify-center"
          />
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-3 md:gap-x-4 mt-2">
            ...
            <BlurText
              ...
              animateBy="words"
              direction="bottom"
              className="text-4xl md:text-7xl lg:text-[5.5rem] font-heading italic text-white leading-[0.8] tracking-[-4px] justify-center"
            />
          </div>
        </div>
